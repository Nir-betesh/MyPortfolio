...
const Skills = () => {
  return (
    <section id="skills" className="transition-colors duration-500 ease-in-out scroll-mt-16 min-h-screen flex flex-col justify-center items-center p-8 bg-white dark:bg-gray-900 dark:text-white pb-12">
