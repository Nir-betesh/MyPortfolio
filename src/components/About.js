  ...
  return (
    ...
    >
      <div className="block max-w-4xl text-center">
        ...
        <p className="text-lg leading-relaxed animate-fade-in opacity-90">
            Hi, I’m 
            ...
            <span className="dark:text-white glow-text dark:dark-glow-text">
        ...
        <div className="mt-8 space-y-6">
          <div className="animate-fade-in-up">
            <h3 className="text-3xl font-semibold dark:text-white glow-text dark:dark-glow-text">
        ...
        <p className="mt-8 text-lg font-semibold animate-fade-in-up">
